 ...
 * Admin API class.
 */
class WT_Post_of_the_Day_Admin_API {
	...
	public function display_field( $data = array(), $post = null, $echo = true ) {
		...
		switch ( $field['type'] ) {
			...
			case 'image':
				...
				$html .= '<input id="' . $option_name . '_button" type="button" data-uploader_title="' . __( 'Upload an image', 'wt-post-of-the-day' ) . '" data-uploader_button_text="' . __( 'Use image', 'wt-post-of-the-day' ) . '" class="image_upload_button button" value="' . __( 'Upload new image', 'wt-post-of-the-day' ) . '" />' . "\n";
				$html .= '<input id="' . $option_name . '_delete" type="button" class="image_delete_button button" value="' . __( 'Remove image', 'wt-post-of-the-day' ) . '" />' . "\n";
